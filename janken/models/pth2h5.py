...
# model_pth = Model()
# model_pth.load_state_dict(torch.load('../model.pth'))
# dummy_input = torch.zeros((1, 3, 480, 640)) # input shape (1, channels, height, width)
# torch.onnx.export(
#     model_pth, dummy_input, "model.onnx",
#     input_names=['input'],
#     output_names=['output'],
# )
...
k_model = onnx_to_keras(model_onnx, ['input'], change_ordering=True,
                        input_shapes=(3, 480, 640), verbose=True)
        ...
        if output_h5:
            ...
            try:
                ...
                try:
                    ...
                    # info(Color.RED(f'json output failed'))
                    print(f'{e=}')
                    error(e)
                    import traceback
